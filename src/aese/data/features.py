...
When a :class:`~aese.data.noise.DEMANDNoiseDataset` is supplied to
:class:`MelPowerSpectrumExtractor`, a noisy copy of the waveform is
synthesised on the fly by :func:`~aese.data.noise.add_noise_snr`.  The
...
.. code-block:: python
    ...
    from aese.data.features import MelPowerSpectrumExtractor
...
from aese.data.noise import DEMANDNoiseDataset, add_noise_snr
...
class BaseExtractor(ABC):
    ...
    :class:`~aese.data.librispeech.LibriSpeechDataset`.  Concrete subclasses
    ...
    .. attribute:: sample_shape
       ...
       :class:`~aese.data.librispeech.LibriSpeechDataset`.
    """
...
class LogMelPowerSpectrumExtractor(BaseExtractor):
    ...
    by :func:`~aese.data.noise.add_noise_snr` at a randomly selected SNR of
